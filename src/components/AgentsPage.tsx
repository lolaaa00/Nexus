  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', padding: '32px 36px' }}>
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        <p style={{ fontSize: 11, fontFamily: 'Space Mono', color: 'rgba(45,31,40,0.25)', letterSpacing: '0.12em', marginBottom: 8 }}>TOOLS</p>
        <h1 style={{ fontSize: 28, fontWeight: 700, fontFamily: 'Space Grotesk', color: '#2d1f28', marginBottom: 6, letterSpacing: '-0.025em' }}>Three tools. Infinite uses.</h1>
        <p style={{ fontSize: 14, color: 'rgba(45,31,40,0.45)', marginBottom: 36, lineHeight: 1.6 }}>Focused, powerful, and built to work together. More on the way.</p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                  <p style={{ fontSize: 20, fontWeight: 700, fontFamily: 'Space Grotesk', color: '#2d1f28', letterSpacing: '-0.02em' }}>Playground</p>
                ...
                <p style={{ fontSize: 13, color: 'rgba(45,31,40,0.45)', lineHeight: 1.6, maxWidth: 500 }}>The centerpiece. Describe anything — a concept, a topic, an idea — and get back something interactive. Play it, share it, learn from it.</p>
              </div>
            </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 32 }}>
          {TOOLS.filter(t => t.name !== 'Playground').map(tool => (
            <div key={tool.name} style={{
              ...
              border: `1px solid ${tool.status === 'active' ? 'rgba(130,88,109,0.15)' : 'rgba(130,88,109,0.07)'}`,
              ...
              <p style={{ fontSize: 14, fontWeight: 600, fontFamily: 'Space Grotesk', color: '#2d1f28', marginBottom: 6, letterSpacing: '-0.01em' }}>{tool.name}</p>
              <p style={{ fontSize: 12, color: 'rgba(45,31,40,0.45)', lineHeight: 1.6 }}>{tool.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div style={{ borderRadius: 16, padding: '24px 28px', background: 'rgba(130,88,109,0.06)', border: '1px solid rgba(130,88,109,0.15)' }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 700, fontFamily: 'Space Grotesk', color: '#2d1f28', marginBottom: 8, letterSpacing: '-0.02em' }}>Built for the Rialo agent economy</h3>
          <p style={{ fontSize: 13, color: 'rgba(45,31,40,0.45)', lineHeight: 1.7, maxWidth: 560 }}>
